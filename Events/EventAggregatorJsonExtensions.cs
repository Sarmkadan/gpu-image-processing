...
{
    /// <summary>
    /// Provides JSON serialization extensions for <see cref="EventAggregator"/>.
    /// </summary>
    public static class EventAggregatorJsonExtensions
    {
        ...
        /// <summary>
        /// Serializes the <see cref="EventAggregator"/> instance to a JSON string.
        /// </summary>
        /// <param name="value">The event aggregator to serialize.</param>
        /// <param name="indented">Whether to format the JSON with indentation for readability.</param>
        /// <returns>A JSON string representation of the event aggregator.</returns>
        ...
        /// <summary>
        /// Deserializes a JSON string to an <see cref="EventAggregator"/> instance.
        /// </summary>
