...
namespace GpuImageProcessing.Core.Repository
{
    ...
    /// </summary>
    public static class GenericRepositoryValidation<T> where T : class
    {
        /// <summary>
        ...
        public static IReadOnlyList<string> Validate(this GenericRepository<T>? value)
        {
        ...
        public static bool IsValid(this GenericRepository<T>? value) => Validate(value).Count == 0;
        ...
        public static void EnsureValid(this GenericRepository<T>? value)
        {
