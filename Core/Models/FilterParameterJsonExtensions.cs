...
{
    /// <summary>
    /// Provides JSON serialization and deserialization extensions for FilterParameter
    /// </summary>
    public static class FilterParameterJsonExtensions
    {
        ...
        /// <returns>The deserialized FilterParameter, or null if JSON is empty</returns>
