...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="BatchProcessingBenchmarks"/>.
/// </summary>
public static class BatchProcessingBenchmarksJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="BatchProcessingBenchmarks"/> instance to a JSON string.
    /// </summary>
    ...
    public static string ToJson(this BatchProcessingBenchmarks value, bool indented = false)
    {
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="BatchProcessingBenchmarks"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <param name="value">Receives the deserialized instance if successful, otherwise null.</param>
    /// <returns>True if deserialization succeeded; otherwise false.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="json"/> is null.</exception>
    public static bool TryFromJson(string json, out BatchProcessingBenchmarks? value)
    {
        ArgumentNullException.ThrowIfNull(json);
        ...
        try
        {
            value = JsonSerializer.Deserialize<BatchProcessingBenchmarks>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
