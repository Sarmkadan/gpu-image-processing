...
/// <summary>
/// Provides System.Text.Json serialization extensions for <see cref="EnumerableExtensionsBenchmarks"/>.
/// </summary>
public static class EnumerableExtensionsBenchmarksJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="EnumerableExtensionsBenchmarks"/> instance to a JSON string.
    /// </summary>
    ...
    public static EnumerableExtensionsBenchmarks? FromJson(string json)
    {
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="EnumerableExtensionsBenchmarks"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <param name="value">Receives the deserialized instance if successful, otherwise null.</param>
    /// <returns>True if deserialization succeeded; otherwise false.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="json"/> is null.</exception>
    public static bool TryFromJson(string json, out EnumerableExtensionsBenchmarks? value)
    {
        ArgumentNullException.ThrowIfNull(json);
        ...
        try
        {
            value = JsonSerializer.Deserialize<EnumerableExtensionsBenchmarks>(json, _jsonOptions);
            return true;
        }
        catch (JsonException)
        {
