...
public class ImageProcessingServiceTests
{
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_ImageNotFound_ThrowsInvalidImageException));
        try
        {
            // Arrange
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_ImageNotFound_ThrowsInvalidImageException));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_ImageNotFound_ThrowsInvalidImageException));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_InvalidImage_ThrowsInvalidImageException));
        try
        {
            // Arrange
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_InvalidImage_ThrowsInvalidImageException));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_InvalidImage_ThrowsInvalidImageException));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_NoGpuDevice_ThrowsGpuException));
        try
        {
            // Arrange
            var image = CreateValidImage();
            ...
            // Log a warning that we are exercising a fallback path (no GPU)
            _loggerMock.Object.LogWarning("No GPU device available – fallback path exercised in {TestName}", nameof(ProcessImageAsync_NoGpuDevice_ThrowsGpuException));
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_NoGpuDevice_ThrowsGpuException));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_NoGpuDevice_ThrowsGpuException));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_SuccessfulProcessing_ReturnsCompletedResult));
        try
        {
            // Arrange
            var image = CreateValidImage();
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_SuccessfulProcessing_ReturnsCompletedResult));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_SuccessfulProcessing_ReturnsCompletedResult));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_MultipleFilters_AppliesAllSequentially));
        try
        {
            // Arrange
            var image = CreateValidImage();
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_MultipleFilters_AppliesAllSequentially));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_MultipleFilters_AppliesAllSequentially));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_FilterApplicationFails_ReturnsFailedResult));
        try
        {
            // Arrange
            var image = CreateValidImage();
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_FilterApplicationFails_ReturnsFailedResult));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_FilterApplicationFails_ReturnsFailedResult));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(ProcessImageAsync_MarksImageAsProcessing));
        try
        {
            // Arrange
            var image = CreateValidImage();
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(ProcessImageAsync_MarksImageAsProcessing));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(ProcessImageAsync_MarksImageAsProcessing));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(GetProcessingResultAsync_ExistingResults_ReturnsLatestResult));
        try
        {
            // Arrange
            var imageId = Guid.NewGuid();
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(GetProcessingResultAsync_ExistingResults_ReturnsLatestResult));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(GetProcessingResultAsync_ExistingResults_ReturnsLatestResult));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(GetProcessingResultAsync_NoResults_ReturnsNull));
        try
        {
            // Arrange
            var imageId = Guid.NewGuid();
            ...
            // Log a warning that we are on a fallback path (no results)
            _loggerMock.Object.LogWarning("No processing results found – fallback path exercised in {TestName}", nameof(GetProcessingResultAsync_NoResults_ReturnsNull));
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(GetProcessingResultAsync_NoResults_ReturnsNull));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(GetProcessingResultAsync_NoResults_ReturnsNull));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(GetStatisticsAsync_ReturnsCorrectMetrics));
        try
        {
            // Arrange
            var totalImages = 10;
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(GetStatisticsAsync_ReturnsCorrectMetrics));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(GetStatisticsAsync_ReturnsCorrectMetrics));
        }
    }
    ...
    {
        _loggerMock.Object.LogInformation("Starting {TestName}", nameof(GetStatisticsAsync_NoResults_ReturnsZeroMetrics));
        try
        {
            // Arrange
            _imageRepositoryMock.Setup(x => x.CountAsync(It.IsAny<CancellationToken>()))
            ...
            // Log a warning that we are on a fallback path (no results)
            _loggerMock.Object.LogWarning("No processing results available – fallback path exercised in {TestName}", nameof(GetStatisticsAsync_NoResults_ReturnsZeroMetrics));
        ...
        {
            _loggerMock.Object.LogError(ex, "Unexpected error in {TestName}", nameof(GetStatisticsAsync_NoResults_ReturnsZeroMetrics));
            throw;
        }
        finally
        {
            _loggerMock.Object.LogInformation("Finished {TestName}", nameof(GetStatisticsAsync_NoResults_ReturnsZeroMetrics));
        }
    }
}
