...
{
    /// <summary>
    /// Provides JSON serialization extensions for <see cref="VersionCommand"/>.
    /// </summary>
    public static class VersionCommandJsonExtensions
    {
        ...
        /// <summary>
        /// Serializes the <see cref="VersionCommand"/> instance to a JSON string.
        /// </summary>
        /// <param name="value">The version command to serialize.</param>
        ...
        /// <summary>
        /// Attempts to deserialize a JSON string to a <see cref="VersionCommand"/> instance.
        /// </summary>
        /// <param name="json">The JSON string to deserialize.</param>
        ...
        public static bool TryFromJson(string json, out VersionCommand? value)
        {
            ...
            try
            {
                value = JsonSerializer.Deserialize<VersionCommand>(json, _jsonOptions);
                return true;
            }
            catch (JsonException)
            {
